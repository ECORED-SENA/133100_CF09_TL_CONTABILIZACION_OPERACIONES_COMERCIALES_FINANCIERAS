  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
          ...
          .row.justify-content-center
            ...
            .col-sm-6.col-lg-5.mb-4.mb-lg-0
              .tarjeta--boton.bg-t1-5.p-4.h-100(data-aos="zoom-in")
                ...
                p Contrario a los no identificables, los activos identificables son activos que se pueden separar. En este caso, podemos señalar algunos ejemplos como los relacionados con la tecnología, bases de datos, #[i software], licencias, entre otros.
    ...
    .row.justify-content-center.bg-t1-6
      .p-lg-5
        ...
        p Nota: se considera su valor en libros teniendo en cuenta el deterioro que ha sufrido el intangible.
        .titulo-sexto.color-acento-contenido.mb-3
              h5 Tabla 4. 
    ...
    p #[b Por ejemplo:]
    p Tomando el caso anterior se tiene, que el activo intangible “marcas”, de acuerdo con factores de mercado se determinó que, su valor razonable es de $1.750.
    .row.justify-content-center
      .col-lg-10.mt-4
        .row.justify-content-center
